...
func (c *RPCClient) Rescan(startHash *chainhash.Hash, addrs []wfcutil.Address,
...
func (c *RPCClient) onRecvTx(tx *wfcutil.Tx, block *btcjson.BlockDetails) {
...
func (c *RPCClient) onRedeemingTx(tx *wfcutil.Tx, block *btcjson.BlockDetails) {
