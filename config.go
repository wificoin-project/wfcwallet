...
type config struct {
	...
	WfcdUsername     string                  `long:"wfcdusername" description:"Username for wfcd authentication"`
	WfcdPassword     string                  `long:"wfcdpassword" default-mask:"-" description:"Password for wfcd authentication"`
