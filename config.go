...
import (
	...
	"github.com/wificoin-project/wfcwallet/internal/legacy/keystore"
...
const (
	defaultCAFilename       = "wfcd.cert"
	defaultConfigFilename   = "wfcwallet.conf"
	defaultLogLevel         = "info"
	defaultLogDirname       = "logs"
	defaultLogFilename      = "wfcwallet.log"
...
var (
	btcdDefaultCAFile  = filepath.Join(btcutil.AppDataDir("wfcd", false), "rpc.cert")
	defaultAppDataDir  = btcutil.AppDataDir("wfcwallet", false)
...
type config struct {
	...
	WfcdUsername     string                  `long:"btcdusername" description:"Username for btcd authentication"`
	WfcdPassword     string                  `long:"btcdpassword" default-mask:"-" description:"Password for btcd authentication"`
...
func loadConfig() (*config, []string, error) {
	...
	if cfg.WfcdUsername == "" {
		cfg.WfcdUsername = cfg.Username
	}
	if cfg.WfcdPassword == "" {
		cfg.WfcdPassword = cfg.Password
	}
