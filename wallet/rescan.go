...
type RescanJob struct {
	...
	OutPoints   map[wire.OutPoint]wfcutil.Address
...
// rescan.
func (w *Wallet) Rescan(addrs []wfcutil.Address, unspent []wtxmgr.Credit) error {
...
func (w *Wallet) rescanWithTarget(addrs []wfcutil.Address,
	unspent []wtxmgr.Credit, startStamp *waddrmgr.BlockStamp) error {

	outpoints := make(map[wire.OutPoint]wfcutil.Address, len(unspent))
